...
${content}`;
    ...
    const savedAnalysis = await prisma.analysis.create({
      data: {
        ...
        readabilityScore: analysisData?.readabilityScore ?? undefined,
        seoScore: analysisData?.seoScore ?? undefined,
        grammarScore: analysisData?.grammarScore ?? undefined,
        accessibilityScore: analysisData?.accessibilityScore ?? undefined,
        engagementScore: analysisData?.engagementScore ?? undefined,
        originalityScore: analysisData?.originalityScore ?? undefined,
        sentimentScore: analysisData?.sentimentScore ?? undefined,
        sourceRelevanceScore: analysisData?.sourceRelevanceScore ?? undefined,
        keywordDensity: analysisData?.keywordDensity ?? undefined,
        processingTimeMs: analysisData?.processing_time_ms ?? undefined,
      },
    });
